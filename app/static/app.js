...
const TRANSLATIONS = {
  en: {
    ...
    qualityDraft: "<b>Draft</b> — ~$0.006 per image, for finding the right motif",
    qualityFinal: "<b>Final</b> — ~$0.21 per image, full quality for the keeper",
    ...
    studioQualityDraft: "<b>Draft</b> — ~$0.006 per image",
    studioQualityFinal: "<b>Final</b> — ~$0.21 per image",
    ...
    tlTransition_cut: "Cut",
    tlTransition_fade: "Fade through black",
    tlTransition_dissolve: "Cross-dissolve",
    tlTransitionHint: "A fade dips through black on both sides of the join.",
    tlTransitionDissolveHint: "A dissolve blends the two clips, so it overlaps them — the film gets shorter by that much.",
    tlTransitionClamped: "Shortened to fit the clips it touches.",
    tlFadeLength: "Transition length (s)",
    tlJoinDissolve: "Cross-dissolve — click for a hard cut",
    tlResolution: "Quality",
    tlRes720: "720p — quick",
    tlRes1080: "1080p — final",
    tlTitleStyle: "Layout",
    tlTitleStyle_center: "Centred",
    tlTitleStyle_lower_third: "Lower third",
    tlTitleStyle_left: "Left, large",
    tlTitleStyle_end_card: "End card",
    tlTitleStyleHint: "Four finished designs — position, size and rule are chosen together.",
    tlVoice: "Voice on this clip",
    tlVoiceNone: "None",
    tlVoiceHint: "Plays on top of whatever audio the clip already has.",
    tlVoiceVolume: "Voice level",
    tlVoiceFit: "Fit to the line",
    tlVoiceFitLabel: "Length",
    tlDuck: "duck",
    tlDuckHint: "Steps this track back whenever the film itself is loud, so music doesn't fight speech.",
    tlPreviewNote: "Preview — looks and camera moves are approximated in the browser; the render is the truth.",
    tlLook: "Look",
  ...
  de: {
    ...
    qualityDraft: "<b>Entwurf</b> – ~$0,006 pro Bild, zum Finden des Motivs",
    qualityFinal: "<b>Final</b> – ~$0,21 pro Bild, volle Qualität für den Keeper",
    ...
    studioQualityDraft: "<b>Entwurf</b> – ~$0,006 pro Bild",
    studioQualityFinal: "<b>Final</b> – ~$0,21 pro Bild",
    ...
    tlTransition_cut: "Schnitt",
    tlTransition_fade: "Blende über Schwarz",
    tlTransition_dissolve: "Überblendung",
    tlTransitionHint: "Eine Blende geht auf beiden Seiten des Übergangs durch Schwarz.",
    tlTransitionDissolveHint: "Eine Überblendung mischt beide Clips, überlappt sie also — der Film wird um genau diese Zeit kürzer.",
    tlTransitionClamped: "Auf die Länge der angrenzenden Clips gekürzt.",
    tlFadeLength: "Übergangsdauer (s)",
    tlJoinDissolve: "Überblendung — klicken für einen harten Schnitt",
    tlResolution: "Qualität",
    tlRes720: "720p — schnell",
    tlRes1080: "1080p — final",
    tlTitleStyle: "Layout",
    tlTitleStyle_center: "Zentriert",
    tlTitleStyle_lower_third: "Bauchbinde",
    tlTitleStyle_left: "Links, groß",
    tlTitleStyle_end_card: "Abbinder",
    tlTitleStyleHint: "Vier fertige Entwürfe — Position, Größe und Linie sind zusammen gewählt.",
    tlVoice: "Stimme auf diesem Clip",
    tlVoiceNone: "Keine",
    tlVoiceHint: "Läuft zusätzlich zu dem Ton, den der Clip schon hat.",
    tlVoiceVolume: "Pegel der Stimme",
    tlVoiceFit: "An die Zeile anpassen",
    tlVoiceFitLabel: "Länge",
    tlDuck: "absenken",
    tlDuckHint: "Nimmt diese Spur zurück, sobald der Film selbst laut wird — damit Musik nicht gegen Sprache anläuft.",
    tlPreviewNote: "Vorschau — Looks und Kamerabewegung sind im Browser angenähert; verbindlich ist der Render.",
    tlLook: "Look",
